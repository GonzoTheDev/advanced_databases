...
ANALYZE SELECT V.EDYEAR,
       C.COUNTYNAME,
       SUM(CASE 
               WHEN V.EDYEAR BETWEEN 2013 AND 2015 AND V.VOTEMODE IN ('Facebook', 'Instagram') THEN 0.2
               WHEN V.EDYEAR BETWEEN 2013 AND 2015 AND V.VOTEMODE IN ('TV', 'Phone') THEN 0.5
